...
//	unsigned hyper _tick_count; //!< elapsed time as time stamp counts
	signed hyper _frequency; //!< time stamp counter frequency in counts per second
	signed hyper _tick_count; //!< elapsed time as time stamp counts
	...
	const static unsigned int MILLISECONDS_PER_SECOND; //!< class constant miliseconds/seconds
