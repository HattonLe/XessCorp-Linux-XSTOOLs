...
const static unsigned int MILLISECONDS_PER_SECOND = 1000000;
...
precision_timer::precision_timer(const double time_sec): _frequency(frequency()), _tick_count(static_cast<signed hyper>(time_sec * _frequency)), _stopped(true) {}
