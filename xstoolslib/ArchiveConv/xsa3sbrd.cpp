...
XSA3SBoard::XSA3SBoard(void)
{
	...
	brdModel = NULL;
	Setup(err,"XSA-3S1000",1);			// use a default board model and parallel port at this point
}
...
// Look at xsboard.h for a description of the interface.
bool XSA3SBoard::CheckChipID(void)
{
...
// Look at xsboard.h for a description of the interface.
bool XSA3SBoard::Configure(string& fileName)
{
...
// Look at xsboard.h for a description of the interface.
bool XSA3SBoard::ConfigureInterface(string& fileName)
{
	XSError& errMsg = fpga.GetErr(); // setup error channel
...
// Look at xsboard.h for a description of the interface.
bool XSA3SBoard::DownloadRAM(string& fileName, bool bigEndianBytes,
...
// Look at xsboard.h for a description of the interface.
bool XSA3SBoard::UploadRAM(string& fileName, const char* format,	
...
// Look at xsboard.h for a description of the interface.
bool XSA3SBoard::DownloadFlash(string& fileName, bool bigEndianBytes,
			bool bigEndianBits, bool doStart, bool doEnd)
{
	XSError& errMsg = fpga.GetErr(); // setup error channel
...
// Look at xsboard.h for a description of the interface.
bool XSA3SBoard::UploadFlash(string& fileName, const char* format,	
				unsigned int loAddr, unsigned int hiAddr,
				bool bigEndianBytes, bool bigEndianBits,	
				bool doStart, bool doEnd)
{
