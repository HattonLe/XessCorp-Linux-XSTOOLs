...
// Look at xsboard.h for a description of the interface.
bool XSABoard::Configure(string& fileName)
{
...
// Look at xsboard.h for a description of the interface.
bool XSABoard::ConfigureInterface(string& fileName)
{
...
// Look at xsboard.h for a description of the interface.
bool XSABoard::DownloadRAM(string& fileName, bool bigEndianBytes,
...
// Look at xsboard.h for a description of the interface.
bool XSABoard::UploadRAM(string& fileName, const char* format,	
...
// Look at xsboard.h for a description of the interface.
bool XSABoard::DownloadFlash(string& fileName, bool bigEndianBytes,
			bool bigEndianBits, bool doStart, bool doEnd)
{
	XSError& errMsg = fpga.GetErr(); // setup error channel
...
// Look at xsboard.h for a description of the interface.
bool XSABoard::UploadFlash(string& fileName, const char* format,	
				unsigned int loAddr, unsigned int hiAddr,
				bool bigEndianBytes, bool bigEndianBits,	
				bool doStart, bool doEnd)
{
