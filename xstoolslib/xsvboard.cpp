...
// Look at xsboard.h for a description of the interface.
bool XSVBoard::Configure(const char *fileName)
{
...
// Look at xsboard.h for a description of the interface.
bool XSVBoard::ConfigureInterface(const char *fileName)
{
...
// Look at xsboard.h for a description of the interface.
bool XSVBoard::DownloadRAM(const char *fileName, bool bigEndianBytes,
...
// Look at xsboard.h for a description of the interface.
bool XSVBoard::UploadRAM(const char *fileName, const char* format,
...
// Look at xsboard.h for a description of the interface.
bool XSVBoard::DownloadFlash(const char *fileName, bool bigEndianBytes,
			bool bigEndianBits, bool doStart, bool doEnd)
{
	XSError& errMsg = fpga.GetErr(); // setup error channel
...
// Look at xsboard.h for a description of the interface.
bool XSVBoard::UploadFlash(const char *fileName, const char* format,
				unsigned int loAddr, unsigned int hiAddr,
				bool bigEndianBytes, bool bigEndianBits,	
				bool doStart, bool doEnd)
{
...
bool XSVBoard::SetFreq(int div, bool extOscPresent)
{
	...
	if(loadOscIntfc)
	{
        cpld.ConfigureCPLD(brdInfo[brdIndex].port[PORTTYPE_LPT].oscBitstreamFile);
		if(errMsg.IsError())
		{
    ...
    cpld.ConfigureCPLD(brdInfo[brdIndex].port[PORTTYPE_LPT].eraseBitstreamFile);
	if(errMsg.IsError())
	{
