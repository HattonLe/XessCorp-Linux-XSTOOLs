...
class XC95KPort : public LPTJTAG
{
    ...
    bool ConfigureCPLD(unsigned char b);

    bool ConfigureCPLD(istream& is, const char *fileName, bool *UserCancelled);

    bool ConfigureCPLD(const char *fileName, bool *UserCancelled);
