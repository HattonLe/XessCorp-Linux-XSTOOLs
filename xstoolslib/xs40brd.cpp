...
// Look at xsboard.h for a description of the interface.
bool XS40Board::Configure(const char *fileName)
{
...
// Look at xsboard.h for a description of the interface.
bool XS40Board::ConfigureInterface(const char *fileName)
{
...
// Look at xsboard.h for a description of the interface.
bool XS40Board::DownloadRAM(const char *fileName, bool bigEndianBytes,
...
// Look at xsboard.h for a description of the interface.
bool XS40Board::UploadRAM(const char *fileName, const char* format,
...
// Look at xsboard.h for a description of the interface.
bool XS40Board::DownloadFlash(const char *fileName, bool bigEndianBytes,
			bool bigEndianBits, bool doStart, bool doEnd)
{
	XSError& errMsg = fpga.GetErr(); // setup error channel
	...
	if(doStart)
	{
        ...
        if(Configure(brdInfo[brdIndex].port[PORTTYPE_LPT].flashBitstreamFile) == false)
		{
...
// Look at xsboard.h for a description of the interface.
bool XS40Board::UploadFlash(const char *fileName, const char* format,
				unsigned int loAddr, unsigned int hiAddr,
				bool bigEndianBytes, bool bigEndianBits,	
				bool doStart, bool doEnd)
{
...
bool XS40Board::SetFreq(int div, bool extOscPresent)
{
    ...
    if(Configure(brdInfo[brdIndex].port[PORTTYPE_LPT].oscBitstreamFile) == false)
	{
...
bool XS40Board::Test(void)
{
    ...
    if(DownloadRAM(brdInfo[brdIndex].port[PORTTYPE_LPT].testObjFile,BIG_ENDIAN_BYTES,LITTLE_ENDIAN_BITS,true,false) == false)
	{
