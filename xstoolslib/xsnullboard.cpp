...
// Look at xsboard.h for a description of the interface.
bool XSNULLBoard::Configure(const char *fileName)
{
...
// Look at xsboard.h for a description of the interface.
bool XSNULLBoard::ConfigureInterface(const char *fileName)
{
...
// Look at xsboard.h for a description of the interface.
bool XSNULLBoard::DownloadRAM(const char *fileName, bool bigEndianBytes,
...
// Look at xsboard.h for a description of the interface.
bool XSNULLBoard::UploadRAM(const char *fileName, const char* format,
...
// Look at xsboard.h for a description of the interface.
bool XSNULLBoard::DownloadFlash(const char *fileName, bool bigEndianBytes,
			bool bigEndianBits, bool doStart, bool doEnd)
{
...
// Look at xsboard.h for a description of the interface.
bool XSNULLBoard::UploadFlash(const char *fileName, const char* format,
				unsigned int loAddr, unsigned int hiAddr,
				bool bigEndianBytes, bool bigEndianBits,	
				bool doStart, bool doEnd)
{
