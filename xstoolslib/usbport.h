...
class USBPort : Transport
{
    ...
    int Setup(XSError *e, int portNum, int endptNum, int Attempts, int pcktSz = USB_MAX_PACKET_SIZE);
    ...
    static list<string> ScanHardware(XSError *err);
