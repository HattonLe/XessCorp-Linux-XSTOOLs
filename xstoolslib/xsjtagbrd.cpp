...
//##########################################################################################################
// Look at xsboard.h for a description of the interface.
bool XSJTAGBoard::Configure(const char *fileName)
{
	...
	if(suffix=="BIT")
	{
		...
		if(GetUSERCODE() != xessjtagCode)
		{
            ...
            if(ConfigureInterface(brdInfo[brdIndex].port[PORTTYPE_USBJTAG].testIntfcBitstreamFile) == false)
			{
...
//##########################################################################################################
// Look at xsboard.h for a description of the interface.
bool XSJTAGBoard::ConfigureInterface(const char *fileName)
{
    if(strlen(fileName)==0)
		return true; // nothing to do, so it must be OK
...
//##########################################################################################################
// Look at xsboard.h for a description of the interface.
bool XSJTAGBoard::DownloadRAM(const char *fileName, bool bigEndianBytes, bool bigEndianBits, bool doStart, bool doEnd)
{
	if(!LoadAndTestJtagPortPtrs())
		return false; // some problem occurred with USB ports to FPGA or CPLD
...
//##########################################################################################################
// Look at xsboard.h for a description of the interface.
bool XSJTAGBoard::UploadRAM(const char *fileName, const char* format, unsigned int loAddr, unsigned int hiAddr,
...
//##########################################################################################################
// Look at xsboard.h for a description of the interface.
bool XSJTAGBoard::DownloadFlash(const char *fileName, bool bigEndianBytes, bool bigEndianBits, bool doStart, bool doEnd)
{
	if(!LoadAndTestJtagPortPtrs())
		return false; // some problem occurred with USB ports to FPGA or CPLD
...
//##########################################################################################################
// Look at xsboard.h for a description of the interface.
bool XSJTAGBoard::UploadFlash(const char *fileName, const char* format, unsigned int loAddr, unsigned int hiAddr,
			bool bigEndianBytes, bool bigEndianBits, bool doStart, bool doEnd)				
{
	if(!LoadAndTestJtagPortPtrs())
		return false; // some problem occurred with USB ports to FPGA or CPLD
